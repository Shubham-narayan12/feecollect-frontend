...
const Faculties = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 ${
                selectedDepartment === dept
                  ? "bg-gradient-to-r from-green-600 to-green-800 text-white shadow-xl scale-105"
                  : "bg-white text-green-700 border-2 border-green-600 hover:bg-green-600 hover:text-white shadow-md"
              }`}
            >
              {dept}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {filteredFaculty.map((faculty, index) => (
            <div
              ...
              className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group animate-fade-in border border-green-100"
            >
              {/* Image */}
      ...
      {/* Stats */}
      <div className="bg-gradient-to-r from-green-700 to-green-900 py-12 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            <div>
              <p className="text-5xl font-bold mb-2 text-yellow-400">100+</p>
              <p className="text-white/90">Expert Teachers</p>
            </div>
            <div>
              <p className="text-5xl font-bold mb-2 text-yellow-400">25+</p>
              <p className="text-white/90">Years Experience</p>
            </div>
            <div>
              <p className="text-5xl font-bold mb-2 text-yellow-400">15+</p>
