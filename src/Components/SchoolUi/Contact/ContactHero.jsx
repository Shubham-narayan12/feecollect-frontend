  ...
  return (
    <section className="relative h-[450px] w-full flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-green-900/90 via-green-800/85 to-black/80 backdrop-blur-[2px]"></div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] transform rotate-180">
        <svg className="relative block w-full h-[50px]" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path 
            ...
            fill="#f0fdf4"   // 👈 light green instead of pure white
          ></path>
        </svg>
      </div>
