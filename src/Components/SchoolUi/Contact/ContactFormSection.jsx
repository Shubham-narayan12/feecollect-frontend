...
const ContactFormSection = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-[40px] shadow-2xl shadow-green-200/40 overflow-hidden border border-green-100">
      <div className="p-8 md:p-16 bg-gradient-to-br from-white to-green-50">
        {/* Header */}
        <div className="text-center mb-12">
          <h3 className="text-3xl md:text-4xl font-extrabold text-gray-800 mb-3">
            Send an <span className="text-green-700">Enquiry</span>
          </h3>
          <p className="text-gray-600 italic max-w-md mx-auto">
            Whether you have a request, a query, or want to know about THAWE
            CENTRAL SCHOOL, use the form below to get in touch with our team.
          </p>
        </div>
