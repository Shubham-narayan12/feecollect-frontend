...
import { searchStudentById } from "../api/studentApi.js";
    ...
    <div className="w-full min-h-full bg-slate-50 px-6 py-4">
      ...
      <div className="mb-6 flex items-center justify-between">
        <nav className="flex items-center text-sm text-slate-600">
          ...
          <span className="text-slate-900 font-bold">Fee Collection</span>
        </nav>

        <button
          onClick={() => navigate(`/?tab=payment-history&student=${studentId}`)}
