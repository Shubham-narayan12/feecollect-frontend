      ...
      return (
        <>
          <div className="text-center mb-6">
            ...
            <p className="text-slate-500">Enter your email address and we'll send you an OTP</p>
          </div>
      ...
      return (
        <>
          <div className="text-center mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-800 mb-2">Enter OTP</h2>
          ...
          <div className="relative z-10 mt-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/30">
              <div className="text-center mb-4">
                <p className="text-blue-200 text-sm font-medium mb-3">Powered by</p>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-white/30 backdrop-blur-sm p-3 rounded-xl border-2 border-white/40">
                      <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center">
                        <span className="text-2xl font-bold bg-gradient-to-br from-blue-600 to-purple-600 bg-clip-text text-transparent">A</span>
                      </div>
                    </div>
                  </div>
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">Adishrisoftech</h3>
                <p className="text-blue-100 text-sm font-semibold mb-4">Innovative Software Solutions</p>
                <div className="bg-white/10 rounded-lg p-3 border border-white/20">
                  <p className="text-white text-xs leading-relaxed">
                    <span className="font-bold">Empowering Education</span> through cutting-edge technology
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2 mt-4">
                ...
                <div className="bg-white/10 rounded-lg px-3 py-2 border border-white/20 text-center">
                  <p className="text-white text-xs font-semibold">👥 User-Friendly</p>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-white/20 text-center">
                <p className="text-blue-200 text-xs">© 2024 Adishrisoftech. All rights reserved.</p>
              </div>
            </div>
          </div>
